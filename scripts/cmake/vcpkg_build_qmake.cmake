...
function(vcpkg_build_qmake)
    ...
    if(VCPKG_TARGET_IS_LINUX)
        set(LD_PATH_BACKUP "$ENV{LD_LIBRARY_PATH}")
    elseif(VCPKG_TARGET_IS_OSX)
        set(LD_PATH_BACKUP "$ENV{DYLD_LIBRARY_PATH}")
    endif()
    ...
    foreach(_buildname ${BUILDTYPES})
        ...
        if(VCPKG_TARGET_IS_LINUX)
            set(ENV{LD_LIBRARY_PATH} "${CURRENT_INSTALLED_DIR}${_BUILD_PREFIX}/lib${VCPKG_HOST_PATH_SEPARATOR}$ENV{LD_LIBRARY_PATH}")
        elseif(VCPKG_TARGET_IS_OSX)
            set(ENV{DYLD_LIBRARY_PATH} "${CURRENT_INSTALLED_DIR}${_BUILD_PREFIX}/lib${VCPKG_HOST_PATH_SEPARATOR}$ENV{DYLD_LIBRARY_PATH}")
        endif()
    ...
    if(VCPKG_TARGET_IS_LINUX)
        set(ENV{LD_LIBRARY_PATH} "${LD_PATH_BACKUP}")
    elseif(VCPKG_TARGET_IS_OSX)
        set(ENV{DYLD_LIBRARY_PATH} "${LD_PATH_BACKUP}")
    endif()
